...
namespace Wabbajack.Compiler.CompilationSteps
{
    public class DeconstructBSAs : ACompilationStep
    {
        ...
        public override async ValueTask<Directive?> Run(RawSourceFile source)
        {
            ...
            var matches = await sourceFiles.PMap(_compiler._limiter, e => _mo2Compiler.RunStack(stack, new RawSourceFile(e, Consts.BSACreationDir.Combine((RelativePath)id, (RelativePath)e.Name))))
                .ToList();
